    ...
    <div ref={containerRef} className="relative">
      ...
      {unusedSuggestions.length > 0 && (
        <div className="mt-3 pt-3 border-t border-[var(--border-color)]">
          <p className="text-xs font-medium text-[var(--color-slate)] mb-2 flex items-center gap-1.5">
            <svg
              className="w-3.5 h-3.5 text-[var(--color-slate-light)]"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <div className="flex flex-wrap gap-1.5">
            {unusedSuggestions.map((suggestion) => (
              <button
                ...
                type="button"
                onClick={() => addTag(suggestion)}
                className="inline-flex items-center gap-1 px-2 py-1 rounded-lg bg-gray-100 text-[var(--color-slate)] text-xs font-medium hover:bg-[var(--color-purple-bg)] hover:text-[var(--color-purple)] transition-colors"
              >
                <svg
                  className="w-3 h-3"
                  fill="none"
